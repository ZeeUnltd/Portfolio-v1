<!-- ++++++++++++++++++++++
Why not just Call me: 08030470290... Smile! enjoy.
+ -->
...
<body class="w3-white">
  ...
  <div class="w3-padding-large" id="main">
    ...
    <header class="w3-container w3-padding-32 w3-center w3-dark" id="home">
      <h3 class="w3-jumbo w3-animate-top" ><span class="w3-hide-small w3-text-black">Hi, I'm</span> Gafar Azeez (Zee).</h3>
      <p class="w3-animate-right pclass" id="data-st"> <span class="w3-hide-small">A</span> Web/Software Developer, I love to Design too.</p>
    ...
    <div class="w3-container w3-black w3-center sec2 w3-text-bold w3-text-yellow ">
      <p><ins>Skillset</ins>  </p> <h3>HTML5, CSS3, PHP, JAVASCRIPT, VUE JS, QUASAR FRAMEWORK, NODE JS(Basic Use),   ADOBE ILLUSTRATOR & PHOTOSHOP, LARAVEL, JQUERY, MVC, W3CSS, BOOTSRAP, WORDPRESS, SQUARESPACE ... 
      </h3>
      <p><ins>Interest/Currently Learning</ins></p> <h3> React, React Native, Flutter and more</h3>
  ...
  <div class="w3-content w3-justify w3-text-black w3-padding-64" id="about">
    ...
    <p>Gafar Azeez recently graduated from the Lagos State University with a Bachelor’s Degree in Computer Science. He is really passionate about programming and wants to be an Expert Software Programmer, He is always ready to learn, He has Designed websites like: 
    <br/>
    
    <p><a href="https://nesh.com.ng" target="_blank"><i class="fa fa-link"> </i>NESH(Nigerian Entrepreneurship Summit & Honors)</a></p>
    <p><a href="https://zee.godiano.com" target="_blank"><i class="fa fa-link"> </i>GODIANO</a></p>
    <p><a href="https://tanzanitetravels.com.ng" target="_blank"><i class="fa fa-link"> </i>TANZANITE</a></p>
    <p><a href="https://wrapcity.ng" target="_blank"><i class="fa fa-link"> </i>WRAPCITY</a></p>
     and more... 
    </p>
...
<div class="w3-display-container mySlides">
  <img src="nesh.png" style="width:100%">
...
<div class="w3-display-container mySlides">
  <img src="wrapcity.jpg" style="width:100%">
  <div class="w3-display-bottomleft w3-large w3-container w3-padding-16 w3-black">
    WRAPCITY
  </div>
</div>
...
<div class="w3-display-container mySlides">
  <img src="godiano.png" style="width:100%">
  <div class="w3-display-bottomleft w3-large w3-container w3-padding-16 w3-black">
    GODIANO
  </div>
</div>
...
<div class="w3-display-container mySlides">
  <img src="tanz.png" style="width:100%">
  <div class="w3-display-bottomleft w3-large w3-container w3-padding-16 w3-black">
    TANZANITE TRAVELS
  </div>
</div>
...
<div class="w3-display-container mySlides">
  <img src="ibwas.png" style="width:100%">
  <div class="w3-display-bottomleft w3-large w3-container w3-padding-16 w3-black">
    IBWAS
  </div>
</div>
...
function showDivs(n) {
  ...
  <div class="w3-padding w3-content w3-text-grey w3-padding-64" id="contact">
    ...
    <div class="w3-section">
      ...
      <h3 class="w3-padding-16 w3-text-black">Social Pages</h3>
    <p class="">@ZeeUnltd </p>
    <p>    <a href="https://twitter.com/zeeunltd" target="_blank"><i class="fa fa-twitter-square fa-fw w3-text-black w3-xxlarge w3-margin-right"></i> </a>
        <a href="https://facebook.com/zeeunltd" target="_blank"><i class="fa fa-facebook-square fa-fw w3-text-black w3-xxlarge w3-margin-right"></i> </a>
        <a href="https://github.com/zeeunltd" target="_blank"><i class="fa fa-github-square fa-fw w3-text-black w3-xxlarge w3-margin-right"></i> </a>
    </p>
    ...
    <footer class="w3-content w3-container w3-padding w3-text-grey w3-xlarge">
      ...
      <p class="w3-medium"><a href="https://www.twitter.com/zeeunltd"  class="w3-hover-text-yellow w3-text-black">©<script type="text/javascript">var year = new Date();document.write(year.getFullYear());</script>
ZeeUnltd <img class ="footer-logo w3-round"src="zeeUnltd.png" alt=" Zee Unlimited Company Logo"></p></a>
